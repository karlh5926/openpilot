...
def create_es_throttle_control(packer, fake_button, es_accel_msg, block_accel=False):

  values = copy.copy(es_accel_msg)
  if block_accel:
    values["Throttle_Cruise"] = 0
...
def create_es_rpm(packer, es_rpm_msg, block_accel):
